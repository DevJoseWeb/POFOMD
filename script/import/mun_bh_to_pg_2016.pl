...
my (
$DATAINICIAL,			$DATAFINAL,			$CD_ANOEXECUCAO,		$CD_EXERCICIO,
$ADMINISTRACAO,			$CODIGO_ORGAO,			$SIGLA_ORGAO,			$NOME_ORGAO,
$CODIGO_UNIDADE_GESTORA,	$NOME_UNIDADE_GESTORA,		$CODIGO_FUNCAO,			$NOME_FUNCAO,
$CODIGO_SUBFUNCAO,		$NOME_SUBFUNCAO,		$CODIGO_PROGRAMA,		$NOME_PROGRAMA,
$PA,				$PAPA,				$CODIGO_ACAO,			$NOME_ACAO,
$CODIGO_DESPESA,		$NOME_DESPESA,			$CATEGORIA_DESPESA,		$NOME_CATEGORIA,
$CODIGO_GRUPO_DESPESA,		$NOME_GRUPO_DESPESA,		$CODIGO_MODALIDADE,		$NOME_MODALIDADE,
$CODIGO_ELEMENTO,		$CODIGO_FONTE,			$NOME_FONTE,			$SLD_ORCADO_ANO,
$VL_ATUALIZADO,			$VL_CONGELADO,			$VL_DESCONGELADO,		$VL_CONGELADOLIQUIDO,
$VL_RESERVADO, 	 		$VL_CANCELADO,			$VL_RESERVADOLIQUIDO, 		$VALOR,
$VL_ANULADO, 	 		$VL_EMPENHADOLIQUIDO, 		$VL_LIQUIDADO,			$VL_PAGO, 
