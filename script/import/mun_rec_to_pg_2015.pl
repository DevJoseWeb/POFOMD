...
$CODIGO_UNIDADE_GESTORA,		$NOME_UNIDADE_GESTORA,			$CODIGO_CATEGORIA,				$NOME_CATEGORIA,
...
\$ANO,							\$MES,						\$CODIGO_ORGAO,					\$NOME_ORGAO,
\$CODIGO_UNIDADE,				\$NOME_UNIDADE,				\$CODIGO_CATEGORIA,				\$NOME_CATEGORIA,
\$CODIGO_GRUPO_DESPESA,			\$NOME_GRUPO_DESPESA,		\$CODIGO_MODALIDADE,			\$NOME_MODALIDADE,
\$CODIGO_ELEMENTO,				\$NOME_ELEMENTO,			\$CODIGO_SUBELEMENTO,			\$NOME_SUBELEMENTO,
\$CODIGO_FUNCAO,				\$NOME_FUNCAO,				\$CODIGO_SUBFUNCAO,				\$NOME_SUBFUNCAO,
\$CODIGO_PROGRAMA,				\$NOME_PROGRAMA,			\$CODIGO_ACAO,					\$NOME_ACAO,
