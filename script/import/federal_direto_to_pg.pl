...
my $schema     = POFOMD::Schema->connect( "dbi:Pg:host=localhost;dbname=pofomd", "postgres", "" );
...
my (
    ...
    $CODIGO_ELEMENTO_DESPESA, $NOME_ELEMENTO_DESPESA, $CODIGO_FUNCAO,        $NOME_FUNCAO,
    $CODIGO_SUBFUNCAO,        $NOME_SUBFUNCAO,        $CODIGO_PROGRAMA,      $NOME_PROGRAMA,
    $CODIGO_ACAO,             $NOME_ACAO,             $LINGUAGEM_CIDADA,     $CODIGO_FAVORECIDO,
    $NOME_FAVORECIDO,         $NUMERO_DOCUMENTO,      $GESTAO_PAGAMENTO,     $DATA_PAGAMENTO,
    $VALOR
);
...
$csv->bind_columns(
    ...
    \$NOME_UNIDADE_GESTORA, \$CODIGO_GRUPO_DESPESA, \$NOME_GRUPO_DESPESA, \$CODIGO_ELEMENTO_DESPESA,
    \$NOME_ELEMENTO_DESPESA, \$CODIGO_FUNCAO, \$NOME_FUNCAO, \$CODIGO_SUBFUNCAO, \$NOME_SUBFUNCAO,    \$CODIGO_PROGRAMA,
    \$NOME_PROGRAMA,         \$CODIGO_ACAO,   \$NOME_ACAO,   \$LINGUAGEM_CIDADA, \$CODIGO_FAVORECIDO, \$NOME_FAVORECIDO,
