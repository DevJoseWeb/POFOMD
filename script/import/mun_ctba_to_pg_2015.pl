...
my $schema     = POFOMD::Schema->connect( "dbi:Pg:host=localhost;dbname=pofomd", "pofomd", "pofomd" );
...
$ANO,						$DATA,					$CODIGO_FONTE,				$NOME_FONTE,
$CODIGO_FUNCAO,				$NOME_FUNCAO,			$CODIGO_PROGRAMA,			$NOME_PROGRAMA,
$CODIGO_ACAO,				$NOME_ACAO,				$CODIGO_SUBFUNCAO,			$NOME_SUBFUNCAO,
$CODIGO_ORGAO,				$NOME_ORGAO,			$CODIGO_DESPESA,			$NOME_DESPESA,
$CODIGO_GRUPO_DESPESA,		$NOME_GRUPO_DESPESA,	$CODIGO_DESPESA_MODALIDADE,	$NOME_MODALIDADE,	
$CODIGO_DESPESA_ELEMENTO,	$NOME_ELEMENTO,			$CPF_CNPJ,					$NR_EMPENHO,
$LICITACAO,					$VALOR,					$CD_ITEM,					$NOME_ITEM,
$NOME_UNIDADE_GESTORA,		$QUANTIDADE,			$VL_PRECO_UNITARIO,			$VL_TOTAL,
$PROTOCOLOSUP,				$DT_TRANSACAO,			$NR_PARCELA,				$TRANSACAO,
